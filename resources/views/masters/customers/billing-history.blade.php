            ...
            <div class="cm-tabs-card">
                ...
                <div class="cm-tab-content">
                    ...
                    <div class="cm-tab-title-row">
                        ...
                        <a href="{{ route('billing.weekly.export', ['customer_id' => $customer->id]) }}" class="cm-btn-outline cm-btn-outline--sm">
...
.cm-status-pill--paid { background: rgba(16, 185, 129, 0.12); color: #059669; }
.cm-status-pill--pending { background: rgba(245, 158, 11, 0.12); color: #d97706; }
.cm-status-pill--generated { background: rgba(59, 130, 246, 0.12); color: #2563eb; }
