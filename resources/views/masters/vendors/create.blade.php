...
<div class="cm-page">
    ...
    <div class="cm-form-header">
        <h1 class="cm-page-title">Register New Vendor</h1>
        <p class="cm-page-sub">Onboard a new strategic partner or supply chain vendor</p>
    </div>

    {{-- Form Shell --}}
    <div class="cm-form-container">
        <form action="{{ route('masters.vendors.store') }}" method="POST" class="cm-card-form">
            @csrf
            ...
            <div class="cm-form-group">
                ...
                <textarea name="notes" rows="3" placeholder="Vendor specifications, items supplied, pricing rules..."
                    class="cm-form-input cm-form-textarea"></textarea>
            </div>

            <div class="cm-form-footer">
                <button type="reset" class="cm-btn-ghost">Reset Fields</button>
