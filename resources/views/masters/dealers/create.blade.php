...
<div class="cm-page">
    ...
    <div class="cm-topbar">
        <div>
            <h1 class="cm-page-title">Add New Dealer</h1>
            <p class="cm-page-sub">Expand your procurement network with a new supplier profile</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="cm-form-card">
        <form action="{{ route('masters.dealers.store') }}" method="POST" class="cm-form-body">
            @csrf
            ...
            <div class="cm-form-grid">
                <div class="cm-form-group">
                    ...
                    <input type="text" name="contact_person" placeholder="e.g. Sales Manager"
                        class="cm-form-input" value="{{ old('contact_person') }}">
                </div>
                <div class="cm-form-group">
                    ...
                    <input type="text" name="phone" required placeholder="+91 00000 00000"
                        class="cm-form-input" value="{{ old('phone') }}">
                </div>
            </div>
            ...
            <div class="cm-form-group">
                ...
                <input type="text" name="location" placeholder="Main Street, City"
                    class="cm-form-input" value="{{ old('location') }}">
            </div>
            ...
            <div class="cm-form-grid">
                <div class="cm-form-group">
                    ...
                    <input type="text" name="route" placeholder="Delivery Route"
                        class="cm-form-input" value="{{ old('route') }}">
                </div>
                <div class="cm-form-group">
            ...
            <div class="cm-form-footer">
                <button type="reset" class="cm-btn-ghost">Reset</button>
