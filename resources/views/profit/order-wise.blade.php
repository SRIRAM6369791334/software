...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-slate-950">Order-wise Profit Tracking</h1>
    <p class="text-sm text-slate-500 mt-0.5">Individual profitability metrics for every customer order</p>
</div>
