...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-slate-950">Year-on-Year Comparison</h1>
    <p class="text-sm text-slate-500 mt-0.5">Comparative financial metrics against previous fiscal periods</p>
</div>
