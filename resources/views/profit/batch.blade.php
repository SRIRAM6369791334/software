...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-slate-950">Batch Performance Analysis</h1>
    <p class="text-sm text-slate-500 mt-0.5">Detailed profitability tracking per poultry batch</p>
</div>
