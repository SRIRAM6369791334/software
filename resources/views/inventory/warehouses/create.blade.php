...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-500 mt-0.5">Register a new storage location or shed</p>
</div>
        ...
        <form action="{{ route('inventory.warehouses.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="location" rows="3" placeholder="Ex: Near Northern Gate, Main Farm"
                          class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all">{{ old('location') }}</textarea>
            </div>
