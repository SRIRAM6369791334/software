...
<div class="cm-page">
    ...
    <div class="cm-table-card" style="max-width: 600px;">
        <form action="{{ route('inventory.warehouses.store') }}" method="POST" style="padding: 1.5rem;">
            @csrf
            ...
            <div class="cm-form-group">
                ...
                <textarea name="location" rows="3" placeholder="Ex: Near Northern Gate, Main Farm"
                          class="cm-form-input" style="resize: vertical; min-height: 64px;">{{ old('location') }}</textarea>
            </div>
