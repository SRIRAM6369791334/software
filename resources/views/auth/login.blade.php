            ...
            <div class="group">
                ...
                <div class="relative">
                    <input type="text" id="login" name="login" required autofocus
                           ...
                           class="peer w-full rounded-2xl border border-white/80 bg-white/60 px-5 py-3.5 text-sm font-semibold text-zinc-900 placeholder-zinc-400 shadow-inner backdrop-blur-md transition-all duration-300 focus:border-emerald-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-500/10 hover:bg-white/80 @error('login') border-rose-300 @enderror">
                </div>
            </div>
