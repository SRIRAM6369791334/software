<?php $__env->startSection('title', 'Record Vendor Payout'); ?>

<?php $__env->startSection('content'); ?>
<div class="animate-fade-in max-w-4xl mx-auto">
    <?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Record Vendor Payout','subtitle' => 'Enter payment details to clear supplier and vendor dues']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Record Vendor Payout','subtitle' => 'Enter payment details to clear supplier and vendor dues']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','href' => ''.e(route('payments.vendors.index')).'','icon' => 'arrow_back']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','href' => ''.e(route('payments.vendors.index')).'','icon' => 'arrow_back']); ?>
                Back to Payouts
...
<?php endif; ?>
    ...
    <div class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/60 dark:border-zinc-800/60 shadow-[0_8px_32px_rgba(0,0,0,0.04)] rounded-3xl overflow-hidden p-6 sm:p-10">
        ...
        <form action="<?php echo e(route('payments.vendors.storeGeneralPayment')); ?>" method="POST" class="space-y-8" x-data="{ cashAmount: 0, bankAmount: 0, paymentMode: 'Cash', bankTransferType: '' }">
            <?php echo csrf_field(); ?>
            ...
            <section class="space-y-4">
                ...
                <div class="p-6 bg-zinc-50 dark:bg-zinc-800/40 rounded-2xl border border-zinc-200/60 dark:border-zinc-700/60 transition-all hover:border-purple-500/30">
                    <?php if($selected_vendor_id && $vendors->count() === 1): ?>
                        <?php $v = $vendors->first(); ?>
                        <input type="hidden" name="vendor_id" value="<?php echo e($v->id); ?>">
                        <div>
                            ...
                            <div class="text-lg font-bold text-zinc-800 dark:text-white">
                                <?php echo e($v->firm_name); ?>

                            </div>
                            <div class="text-sm font-semibold text-rose-500 mt-1">
                                Pending Balance: Rs <?php echo e(number_format($v->outstanding_balance, 2)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.select','data' => ['name' => 'vendor_id','label' => 'Select Vendor','required' => true,'onchange' => 'if(this.value) window.location.href=\''.e(route('payments.vendors.create')).'?vendor_id=\'+this.value']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'vendor_id','label' => 'Select Vendor','required' => true,'onchange' => 'if(this.value) window.location.href=\''.e(route('payments.vendors.create')).'?vendor_id=\'+this.value']); ?>
                            ...
                            <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($v->id); ?>" <?php echo e($selected_vendor_id == $v->id ? 'selected' : ''); ?>>
                                <?php echo e($v->firm_name); ?> — Outstanding: Rs <?php echo e(number_format($v->outstanding_balance, 0)); ?>
...
<?php endif; ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $dayLoadEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="hover:bg-zinc-50/50 transition-colors">
                                        <td class="px-4 py-4 text-center">
                                            <input type="checkbox" name="selected_entry_ids[]" value="<?php echo e($entry->id); ?>" data-remaining="<?php echo e($balance); ?>" onchange="updateSelectedDuesTotal()" class="day-load-checkbox rounded border-zinc-300 dark:border-zinc-700 text-purple-600 focus:ring-purple-500 bg-white dark:bg-zinc-900">
                                        </td>
                                        ...
                                        <td class="px-4 py-4 text-zinc-600 dark:text-zinc-400">
                                            <?php echo e($entry->dealer?->firm_name ?? '—'); ?>
                                        ...
                                        <td class="px-4 py-4 text-right font-mono text-zinc-700 dark:text-zinc-300">
                                            ₹<?php echo e(number_format($entry->billing_rate ?: $entry->paper_rate, 2)); ?>

                                        </td>
                                        <td class="px-4 py-4 text-right font-bold font-mono text-zinc-900 dark:text-zinc-100">
                                            ₹<?php echo e(number_format($entry->vendor_cost, 2)); ?>

                                        </td>
                                        <td class="px-4 py-4 text-right font-mono text-zinc-500">
                                            ₹<?php echo e(number_format($entry->vendor_paid, 2)); ?>
            ...
            <?php if($selected_vendor_id && $pendingDayLoadCount > 0): ?>
                <div class="p-4 rounded-2xl border border-amber-200 bg-amber-50 dark:border-amber-800/50 dark:bg-amber-900/20 flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm font-bold text-amber-800 dark:text-amber-300">
                            This vendor has <?php echo e($pendingDayLoadCount); ?> unpaid day-load <?php echo e(Str::plural('entry', $pendingDayLoadCount)); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-zinc-100 dark:border-zinc-800">
                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['type' => 'button','variant' => 'outline','href' => ''.e(route('payments.vendors.index')).'','class' => 'hover:bg-zinc-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'outline','href' => ''.e(route('payments.vendors.index')).'','class' => 'hover:bg-zinc-100']); ?>Cancel <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'primary','icon' => 'check_circle','size' => 'lg','class' => 'shadow-xl shadow-purple-500/20 px-8 !bg-purple-600 hover:!bg-purple-700']); ?>Confirm & Record <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Poultry Management System\flockwise-biztrack-main\flockwise-biztrack-laravel\resources\views/payments/vendors/create.blade.php ENDPATH**/ ?>