                        ...
                        <tbody class="divide-y divide-zinc-150">
                            <?php $__currentLoopData = $dayLoadEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-zinc-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-3">
                                        <?php if($entry->daily_bill_id || $entry->dailyBill): ?>
                                            <div class="space-y-1">
                                                ...
                                                <?php if($collected >= $total && $total > 0): ?>
                                                    <span class="inline-block px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-100 text-emerald-800">Paid: ₹<?php echo e(number_format($collected, 0)); ?> ✅</span>
                                                <?php elseif($collected > 0): ?>
                                                    <span class="inline-block px-2 py-0.5 rounded text-[10px] font-bold bg-amber-100 text-amber-800">Paid: ₹<?php echo e(number_format($collected, 0)); ?> ⏳</span>
                                                <?php else: ?>
