...
<?php unset($__componentOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
<?php endif; ?>
                            <form action="<?php echo e(route('payments.dealers.destroy', $p->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Undo/Delete this payment of Rs <?php echo e(number_format($p->amount, 2)); ?>?');">
                                <?php echo csrf_field(); ?>
