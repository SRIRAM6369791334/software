...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','href' => ''.e(route('billing.investments.index')).'','icon' => 'savings']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','href' => ''.e(route('billing.investments.index')).'','icon' => 'savings']); ?>
                Capital & Investments
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','href' => ''.e(route('masters.vendors.index')).'','icon' => 'local_shipping']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','href' => ''.e(route('masters.vendors.index')).'','icon' => 'local_shipping']); ?>
                Vendor Advances
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
        ...
        <div class="flex flex-wrap items-center gap-4 sm:gap-6">
            ...
            <div class="text-right">
                ...
                <span class="font-jetbrains font-bold text-sm text-emerald-600 dark:text-emerald-400">
                    Rs <?php echo e(number_format($latestCashBalance, 2)); ?>
            ...
            <div class="text-right">
                ...
                <span class="font-jetbrains font-bold text-sm text-blue-600 dark:text-blue-400">
                    Rs <?php echo e(number_format($latestBankBalance, 2)); ?>
            ...
            <div class="text-right">
                <a href="<?php echo e(route('billing.investments.index')); ?>" class="group block">
                    ...
                    <span class="font-jetbrains font-bold text-sm text-indigo-700 dark:text-indigo-300">
                        Rs <?php echo e(number_format($currentInvestmentBalance, 2)); ?>
            ...
            <div class="text-right">
                <a href="<?php echo e(route('masters.vendors.index')); ?>" class="group block">
                    ...
                    <span class="font-jetbrains font-bold text-sm text-amber-700 dark:text-amber-300">
                        Rs <?php echo e(number_format($totalActiveVendorAdvances, 2)); ?>
            ...
            <div class="pl-4 border-l border-zinc-300 dark:border-zinc-700 text-right">
                ...
                <span class="font-jetbrains font-black text-base text-indigo-600 dark:text-indigo-400">
                    Rs <?php echo e(number_format($totalConsolidatedLiquidity, 2)); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal527fae77f4db36afc8c8b7e9f5f81682 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal527fae77f4db36afc8c8b7e9f5f81682 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stat-card','data' => ['label' => 'Total Bank Expense','value' => 'Rs '.e(number_format($totalBankExpense, 0)).'','icon' => 'account_balance','color' => 'amber']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Total Bank Expense','value' => 'Rs '.e(number_format($totalBankExpense, 0)).'','icon' => 'account_balance','color' => 'amber']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal527fae77f4db36afc8c8b7e9f5f81682)): ?>
<?php $attributes = $__attributesOriginal527fae77f4db36afc8c8b7e9f5f81682; ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal527fae77f4db36afc8c8b7e9f5f81682 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal527fae77f4db36afc8c8b7e9f5f81682 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stat-card','data' => ['label' => 'Operating Cash & Bank','value' => 'Rs '.e(number_format($currentTotalBalance, 0)).'','icon' => 'account_balance_wallet','color' => 'indigo','subtitle' => 'In Hand + Bank']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Operating Cash & Bank','value' => 'Rs '.e(number_format($currentTotalBalance, 0)).'','icon' => 'account_balance_wallet','color' => 'indigo','subtitle' => 'In Hand + Bank']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal527fae77f4db36afc8c8b7e9f5f81682)): ?>
<?php $attributes = $__attributesOriginal527fae77f4db36afc8c8b7e9f5f81682; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.data-table','data' => ['headers' => ['Date', 'Cash Income', 'Bank Income', 'Cash Expense', 'Bank Expense', 'Opening Cash', 'Closing Cash', 'Opening Bank', 'Closing Bank', 'Total Balance', 'Actions', 'Status', '']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Date', 'Cash Income', 'Bank Income', 'Cash Expense', 'Bank Expense', 'Opening Cash', 'Closing Cash', 'Opening Bank', 'Closing Bank', 'Total Balance', 'Actions', 'Status', ''])]); ?>
            <?php $__empty_1 = true; $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                    <td class="px-6 py-4">
                        ...
                        ?>
                        <a href="<?php echo e(route('billing.cash-bank-ledger.show-day', $dStr)); ?>" class="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                        ...
                        <?php if($hasWithdrawal > 0): ?>
                            <span class="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-md text-[10px] font-bold bg-rose-50 text-rose-700 border border-rose-200 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-800" title="Owner Drawings / Capital Withdrawn from Pool">
                                ...
                                Drawings: -Rs <?php echo e(number_format($hasWithdrawal, 0)); ?>

                            </span>
                        <?php endif; ?>
                        <?php if($hasInvestment > 0): ?>
                            <span class="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-md text-[10px] font-bold bg-purple-50 text-purple-700 border border-purple-200 dark:bg-purple-950/40 dark:text-purple-300 dark:border-purple-800" title="Capital Inflow into Pool">
                                ...
                                Capital: +Rs <?php echo e(number_format($hasInvestment, 0)); ?>
                    ...
                    <td class="px-6 py-4">
                        <span class="font-jetbrains font-bold text-amber-600">Rs <?php echo e(number_format((float) $ledger->bank_expense, 0)); ?></span>
                    </td>
                    <td class="px-6 py-4">
