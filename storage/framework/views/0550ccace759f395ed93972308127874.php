...
<div class="cm-page">
    ...
    <div class="cm-topbar">
        <div>
            ...
            <p class="cm-page-sub">Update credentials for <?php echo e($warehouse->name); ?></p>
        </div>
    </div>

    <div class="cm-table-card" style="max-width: 600px;">
        <form action="<?php echo e(route('inventory.warehouses.update', $warehouse->id)); ?>" method="POST" style="padding: 1.5rem;">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            
            <div class="cm-form-group">
                <label class="cm-form-label">Warehouse Name <span class="cm-required">*</span></label>
                <input type="text" name="name" required value="<?php echo e(old('name', $warehouse->name)); ?>"
                       class="cm-form-input">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="cm-form-group">
                ...
                <textarea name="location" rows="3"
                          class="cm-form-input" style="resize: vertical; min-height: 64px;"><?php echo e(old('location', $warehouse->location)); ?></textarea>
            </div>
            ...
            <div style="margin-top: 1.5rem; padding: 1rem; background: var(--cm-bg); border-radius: 8px; border: 0.5px dashed var(--cm-card-border);">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    ...
                    <input type="checkbox" name="is_active" value="1" <?php echo e($warehouse->is_active ? 'checked' : ''); ?> style="width: 18px; height: 18px;">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Poultry Management System\flockwise-biztrack-main\flockwise-biztrack-laravel\resources\views\inventory\warehouses\edit.blade.php ENDPATH**/ ?>