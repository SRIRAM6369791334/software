...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Batch Management','subtitle' => 'Track poultry flock lifecycle, placements, and performance']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Batch Management','subtitle' => 'Track poultry flock lifecycle, placements, and performance']); ?>
        <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('inventory.batches.create')).'','icon' => 'add']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('inventory.batches.create')).'','icon' => 'add']); ?>
            Start New Batch
...
<?php $component->withAttributes(['class' => 'flex items-start gap-4']); ?>
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-zinc-950"><?php echo e($batches->where('status', 'Active')->count()); ?></h3>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'flex items-start gap-4']); ?>
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-blue-600"><?php echo e(number_format($batches->where('status', 'Active')->sum('current_count'))); ?></h3>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
...
<?php $component->withAttributes(['class' => 'flex items-start gap-4']); ?>
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-amber-600"><?php echo e(number_format($batches->avg('avg_placement_weight'), 2)); ?>g</h3>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
...
<?php $component->withAttributes(['class' => 'flex items-start gap-4']); ?>
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-zinc-400"><?php echo e($batches->where('status', 'Closed')->count()); ?></h3>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
...
<?php $component->withAttributes(['class' => 'mb-6']); ?>
        <form action="<?php echo e(route('inventory.batches.index')); ?>" method="GET" class="flex flex-wrap items-center gap-4">
            <div class="flex-1 min-w-[240px]">
                <?php if (isset($component)) { $__componentOriginal5c2a97ab476b69c1189ee85d1a95204b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5c2a97ab476b69c1189ee85d1a95204b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input','data' => ['type' => 'text','name' => 'search','value' => ''.e(request('search')).'','placeholder' => 'Search by batch code or breed...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'search','value' => ''.e(request('search')).'','placeholder' => 'Search by batch code or breed...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.select','data' => ['name' => 'status','onchange' => 'this.form.submit()','options' => ['Active' => 'Active', 'Closed' => 'Closed'],'value' => ''.e(request('status')).'','placeholder' => 'All Status']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'status','onchange' => 'this.form.submit()','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Active' => 'Active', 'Closed' => 'Closed']),'value' => ''.e(request('status')).'','placeholder' => 'All Status']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if(request()->anyFilled(['search', 'status'])): ?>
                <a href="<?php echo e(route('inventory.batches.index')); ?>" class="text-xs font-bold text-rose-500 hover:bg-rose-50 px-3 py-2 rounded-lg transition-colors">Clear Filters</a>
            <?php endif; ?>
        </form>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['padding' => 'none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                    ...
                    <tr class="group">
                        <td>
                            <div class="flex flex-col">
                                <span class="font-bold text-zinc-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors"><?php echo e($batch->batch_code); ?></span>
                                <span class="text-[10px] text-zinc-500 font-bold uppercase tracking-tight"><?php echo e($batch->breed ?: 'Generic Breed'); ?></span>
                                <span class="text-[10px] text-zinc-400 mt-1">Placed: <?php echo e($batch->placement_date->format('d M Y')); ?></span>
                            </div>
                        </td>
                        <td>
                            <?php
                            ...
                            ?>
                            <div class="flex flex-col">
                                <span class="text-lg font-black text-zinc-700 dark:text-zinc-300"><?php echo e($days); ?> Days</span>
                        ...
                        <td>
                            <div class="flex flex-col">
                                <div class="flex items-end gap-1">
                                    <span class="text-lg font-black text-zinc-900 dark:text-white"><?php echo e(number_format($batch->current_count)); ?></span>
...
<?php endif; ?>
                        ...
                        <td>
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?php echo e(route('inventory.batches.edit', $batch)); ?>" 
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-20 text-center">
                            <div class="flex flex-col items-center opacity-40">
                                ...
                                <a href="<?php echo e(route('inventory.batches.create')); ?>" class="text-emerald-600 text-xs mt-2 underline font-bold">Start your first batch now</a>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Poultry Management System\flockwise-biztrack-main\flockwise-biztrack-laravel\resources\views\inventory\batches\index.blade.php ENDPATH**/ ?>