        ...
        <div class="lg:col-span-2">
            <div id="cm-tabs-container" class="bg-white/30 dark:bg-zinc-900/40 backdrop-blur-2xl border border-white/60 dark:border-zinc-800/80 rounded-[2rem] overflow-hidden shadow-[0_8px_32px_rgba(31,38,135,0.07)] z-10 relative">
                <div class="flex flex-wrap p-2 m-4 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-md rounded-2xl border border-white/50 dark:border-zinc-700/50 gap-2">
                    ...
                    <a href="<?php echo e(route('payments.dealers.ledger', $dealer)); ?>" class="flex-1 text-center py-3 text-sm font-bold text-emerald-700 dark:text-emerald-400 bg-white/70 dark:bg-zinc-800/80 border border-black dark:border-white shadow-sm rounded-xl transition-all duration-300">
                        Payment Ledger
                    </a>
                                ...
                                <template x-if="open">
                                    <tr>
                                        <td colspan="5" class="px-6 py-2 bg-zinc-50/70 dark:bg-zinc-800/30">
                                            <div class="space-y-1">
                                                <?php $__currentLoopData = $row['sub_items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex items-center justify-between text-sm px-4 py-1.5 rounded-lg <?php echo e($sub['entry_label'] === 'Unallocated / Advance' ? 'bg-amber-50 dark:bg-amber-900/10 text-amber-700 dark:text-amber-300' : 'text-zinc-600 dark:text-zinc-400'); ?>">
                                                        <span class="text-xs"><?php echo e($sub['entry_label']); ?></span>
                                                        <span class="font-jetbrains font-bold">Rs <?php echo e(number_format($sub['amount'], 2)); ?></span>
                                                    </div>
