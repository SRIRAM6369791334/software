        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="rounded-3xl p-6 bg-rose-500/40 dark:bg-rose-900/40 backdrop-blur-2xl text-rose-900 dark:text-rose-100 shadow-[0_8px_32px_rgba(244,63,94,0.15)] border border-rose-300/50 dark:border-rose-700/50 relative overflow-hidden transition-all duration-300 hover:-translate-y-1">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <form action="<?php echo e(route('payments.vendors.payments.store', $vendor)); ?>" method="POST" class="text-left space-y-4 bg-white/80 dark:bg-zinc-900/80 p-5 rounded-[1.25rem] backdrop-blur-xl shadow-sm border border-white/50 dark:border-zinc-700/50" x-data="{ cashAmount: 0, bankAmount: 0 }">
                        <?php echo csrf_field(); ?>
