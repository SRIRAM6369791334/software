...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stat-card','data' => ['label' => 'Total Paid Out','value' => 'Rs '.e(number_format($totalPaidOut, 0)).'','icon' => 'payments','color' => 'purple']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Total Paid Out','value' => 'Rs '.e(number_format($totalPaidOut, 0)).'','icon' => 'payments','color' => 'purple']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
