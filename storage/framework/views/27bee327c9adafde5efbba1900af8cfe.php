...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="meta">
                System Audit Report &bull; Generated on <?php echo e(now()->format('d M Y, h:i A')); ?> &bull; Admin: <?php echo e(auth()->user()->name ?? 'System'); ?>
            ...
            <tr>
                ...
                <td style="width: 33.33%;">
                    <div class="summary-card">
                        ...
                        <div class="summary-value">Rs <?php echo e(number_format($data->sum('amount'), 2)); ?></div>
                    </div>
                </td>
                <td style="width: 33.33%;">
                    <div class="summary-card" style="border-left: 4px solid #059669;">
                        <div class="summary-label">Total Net Revenue</div>
                        <div class="summary-value" style="color: #059669;">Rs <?php echo e(number_format($data->sum('net_amount'), 2)); ?></div>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="font-bold"><?php echo e($row->customer->name ?? 'Unknown Customer'); ?></div>
                        <div style="font-size: 8px; color: #999; margin-top: 2px;">INV: <?php echo e($row->invoice_no); ?></div>
                    </td>
                    <td>
                        <div>
                            ...
                            <?php else: ?>
                                <?php echo e($row->period_start->format('d M')); ?> - <?php echo e($row->period_end->format('d M Y')); ?>

                            <?php endif; ?>
                        </div>
                        <div style="font-size: 8px; color: #999; margin-top: 2px;">STATUS: <?php echo e(strtoupper($row->status)); ?></div>
                    </td>
                    <td class="text-right">Rs <?php echo e(number_format($row->amount, 2)); ?></td>
                    <td class="text-right">Rs <?php echo e(number_format($row->gst_amount, 2)); ?></td>
                    <td class="text-right font-bold">Rs <?php echo e(number_format($row->net_amount, 2)); ?></td>
                </tr>
        ...
        <div class="footer">
            Poultry Management ERP &bull; CONFIDENTIAL FINANCIAL DOCUMENT &bull; PAGE 1 OF 1
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Poultry Management System\flockwise-biztrack-main\flockwise-biztrack-laravel\resources\views\reports\pdf\sales.blade.php ENDPATH**/ ?>