...
>
    ...
    <div
        x-show="show"
        class="relative w-full bg-white dark:bg-zinc-900 rounded-[20px] shadow-[0_25px_80px_rgba(15,23,42,0.2),0_8px_32px_rgba(15,23,42,0.08)] dark:shadow-[0_25px_80px_rgba(0,0,0,0.5)] max-w-[95vw] <?php echo e($maxWidthClass); ?> border border-zinc-200/50 dark:border-zinc-800/50 flex flex-col max-h-[calc(100vh-64px)]"
        x-transition:enter="ease-out duration-200"
        ...
        <div class="flex-shrink-0 px-6 sm:px-8 pt-6 sm:pt-8 pb-0">
            <div class="flex items-start justify-between mb-7">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <?php if($title): ?>
                            <h3 id="modal-title-<?php echo e($name); ?>" class="text-lg font-bold text-zinc-900 dark:text-white font-cabinet"><?php echo e($title); ?></h3>
                        <?php endif; ?>
                        <?php if($subtitle): ?>
                            <p class="mt-0.5 text-sm text-zinc-500 dark:text-zinc-400"><?php echo e($subtitle); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
