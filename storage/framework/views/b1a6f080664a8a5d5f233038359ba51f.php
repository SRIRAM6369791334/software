<?php $__env->startSection('title', 'Dealer Details - ' . $dealer->firm_name); ?>
            ...
            <div class="rounded-3xl p-6 bg-amber-500/40 dark:bg-amber-900/40 backdrop-blur-2xl text-amber-900 dark:text-amber-100 shadow-[0_8px_32px_rgba(245,158,11,0.15)] border border-amber-300/50 dark:border-amber-700/50 relative overflow-hidden transition-all duration-300 hover:shadow-[0_8px_32px_rgba(245,158,11,0.25)] hover:-translate-y-1">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <div class="text-3xl font-extrabold tracking-tight font-jetbrains mb-6 text-amber-950 dark:text-white drop-shadow-sm">
                        Rs <?php echo e(number_format($dealer->pending_amount, 2)); ?>
        ...
        <div class="lg:col-span-2">
            <div id="cm-tabs-container" class="bg-white/30 dark:bg-zinc-900/40 backdrop-blur-2xl border border-white/60 dark:border-zinc-800/80 rounded-[2rem] overflow-hidden shadow-[0_8px_32px_rgba(31,38,135,0.07)] z-10 relative">
                <div class="flex flex-wrap p-2 m-4 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-md rounded-2xl border border-white/50 dark:border-zinc-700/50 gap-2">
                    <a href="<?php echo e(route('masters.dealers.show', $dealer)); ?>" class="flex-1 text-center py-3 text-sm font-bold text-emerald-700 dark:text-emerald-400 bg-white/70 dark:bg-zinc-800/80 shadow-sm rounded-xl transition-all duration-300">
                        Quick Overview
                    </a>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view dealer purchases')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view dealer ledger')): ?>
                                        ...
                                        <div>
                                            <p class="font-bold text-sm text-zinc-900 dark:text-zinc-100">
                                                <?php if($purchase->items->isNotEmpty()): ?>
                                                    <?php echo e(str($purchase->items->pluck('item_name')->join(', '))->limit(25)); ?>

                                                <?php else: ?>
                                                    <?php echo e(str($purchase->item)->limit(25)); ?>

                                                <?php endif; ?>
                                            </p>
                                            <p class="text-xs font-medium text-zinc-500 mt-0.5"><?php echo e($purchase->date->format('d M Y')); ?></p>
                                        </div>
                                    </div>
                                ...
                                <div class="flex justify-between items-center p-4 rounded-2xl border border-white/60 dark:border-zinc-700 shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)] bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl transition-all duration-300 hover:bg-white/60 hover:-translate-y-0.5">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs font-medium text-zinc-500 mt-0.5"><?php echo e($payment->payment_mode); ?> &bull; <?php echo e($payment->date->format('d M Y')); ?></p>
                                        </div>
                                    </div>
                                    <div class="font-bold text-base text-emerald-600 dark:text-emerald-400 font-jetbrains">
                                        Rs <?php echo e(number_format($payment->amount, 0)); ?>
                    ...
                    <div class="pt-6 border-t border-zinc-200 dark:border-zinc-800">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <div class="p-4 rounded-2xl border border-white/60 dark:border-zinc-700 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl">
                                ...
                                <div class="text-lg font-bold text-zinc-900 dark:text-zinc-100 font-jetbrains"><?php echo e(number_format($totalBoxesReceived)); ?></div>
                            </div>
                            <div class="p-4 rounded-2xl border border-white/60 dark:border-zinc-700 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl">
                            ...
                            <div class="p-4 rounded-2xl border border-white/60 dark:border-zinc-700 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl">
                                ...
                                <div class="text-lg font-bold <?php echo e($lossRate > 5 ? 'text-rose-600 dark:text-rose-400' : 'text-emerald-600 dark:text-emerald-400'); ?> font-jetbrains"><?php echo e($lossRate); ?>%</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Poultry Management System\flockwise-biztrack-main\flockwise-biztrack-laravel\resources\views/masters/dealers/show.blade.php ENDPATH**/ ?>