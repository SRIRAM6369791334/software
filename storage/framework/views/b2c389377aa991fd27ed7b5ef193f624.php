...
<div class="stats">
    <div class="stat-card sc-blue">
        ...
        <div class="s-value"><?php echo e($purchaseCount); ?></div>
    </div>
    <div class="stat-card sc-green">
        <div class="s-label">Purchase Total</div>
        <div class="s-value">Rs <?php echo e(number_format($purchaseTotal, 0)); ?></div>
    </div>
    <div class="stat-card sc-amber">
        <div class="s-label">Day-Load Batches</div>
        <div class="s-value"><?php echo e($dayLoadBatch ? 1 : 0); ?></div>
    </div>
...
<table>
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right font-bold font-mono"><?php echo e(number_format((float) ($dayLoadBatch?->total_farm_weight ?? $dayLoadEntries->sum('farm_weight')), 2)); ?></td>
            <td class="text-right font-bold font-mono text-rose"><?php echo e(number_format((float) ($dayLoadBatch?->total_loss_weight ?? $dayLoadEntries->sum('loss_weight')), 2)); ?></td>
        </tr>
    </tfoot>
</table>
<?php endif; ?>
