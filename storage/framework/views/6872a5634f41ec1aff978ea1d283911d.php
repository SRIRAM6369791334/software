<?php $__env->startSection('title', 'INVOICE — ' . ($bill->invoice_no ?? 'INV')); ?>
<?php $__env->startSection('meta', "Invoice No: {$bill->invoice_no} | Period: {$bill->period_start->format('d M')} – {$bill->period_end->format('d M Y')}"); ?>
...
<table class="header-table">
    <tr>
        ...
        <td style="text-align:right; vertical-align:top;">
            <div class="invoice-badge <?php echo e($bill->status === 'Paid' ? '' : 'invoice-badge-pending'); ?>">
                <?php echo e($bill->status === 'Paid' ? '✅ Paid' : '⏳ ' . $bill->status); ?>
...
<table class="party-table">
    <tr>
        <td>
            ...
            <div class="party-name"><?php echo e($bill->dealer?->firm_name ?? 'N/A'); ?></div>
            <div style="color:#4b5563; margin-top:2px;"><?php echo e($bill->dealer?->location ?? ''); ?></div>
            <div style="color:#4b5563;">📞 <?php echo e($bill->dealer?->phone ?? 'N/A'); ?></div>
            <?php if($bill->dealer?->gst_number): ?>
                <div style="color:#6b7280; font-size:8px; margin-top:2px;">GSTIN: <?php echo e($bill->dealer->gst_number); ?></div>
            <?php endif; ?>
        </td>
        <td style="text-align:right;">
            ...
            <table class="meta-table" style="float:right; width:auto;">
                <tr>
                    ...
                    <td style="font-weight:bold; text-align:right; padding: 1px 0 1px 8px; font-family:monospace;"><?php echo e($bill->invoice_no ?? ('INV-W-' . str_pad($bill->id, 4, '0', STR_PAD_LEFT))); ?></td>
                </tr>
                <tr>
                    <td style="color:#6b7280; text-align:right; padding: 1px 0;">Generated:</td>
                    <td style="text-align:right; padding: 1px 0 1px 8px;"><?php echo e(now()->format('d M Y')); ?></td>
                </tr>
                <tr>
                    <td style="color:#6b7280; text-align:right; padding: 1px 0;">Payment Mode:</td>
                    <td style="text-align:right; padding: 1px 0 1px 8px;"><?php echo e($bill->payment_mode ?? 'Credit'); ?></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table class="stats-table" style="width:100%;">
    <tr>
        <td class="stat-blue" style="padding: 8px;">
            ...
            <div class="stat-val">₹<?php echo e(number_format((float)($bill->previous_outstanding ?? 0), 2)); ?></div>
        </td>
        <td class="stat-green" style="padding: 8px; border-left: 0;">
            <div class="stat-lbl">This Week's Day-Load</div>
            <div class="stat-val">+ ₹<?php echo e(number_format($dayLoadTotal ?? $bill->amount, 2)); ?></div>
        </td>
        <td class="stat-amber" style="padding: 8px; border-left: 0;">
            <div class="stat-lbl">Payments During Week</div>
            <div class="stat-val">- ₹<?php echo e(number_format((float)($bill->payments_during_week ?? 0), 2)); ?></div>
        </td>
        <td class="stat-purple" style="padding: 8px; border-left: 0;">
            <div class="stat-lbl">Net Invoice Amount</div>
            <div class="stat-val">₹<?php echo e(number_format((float)($bill->net_amount ?? $bill->amount), 2)); ?></div>
        </td>
    </tr>
</table>
...
<table class="data-table">
    ...
    <tbody>
        <?php $__currentLoopData = $dayLoadEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <tr>
                <td><?php echo e($entry->batch?->billing_date?->format('d M Y') ?? '—'); ?></td>
                <td style="color:#6b7280;"><?php echo e($entry->batch?->billing_date?->format('l') ?? ''); ?></td>
                <td><?php echo e($entry->vendor?->firm_name ?? '—'); ?></td>
                <td class="text-right" style="font-family:monospace;"><?php echo e(number_format($kg, 2)); ?> kg</td>
                <td class="text-right" style="font-family:monospace;">₹<?php echo e(number_format($rate, 2)); ?></td>
                <td class="text-right" style="font-weight:bold; font-family:monospace; color:#047857;">₹<?php echo e(number_format($total, 2)); ?></td>
            </tr>
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right" style="font-family:monospace; color:#374151;"><?php echo e(number_format($dayLoadEntries->sum('bird_weight'), 2)); ?> kg</td>
            <td></td>
            <td class="text-right" style="font-size:11px; font-family:monospace; color:#047857;">₹<?php echo e(number_format($dayLoadTotal ?? 0, 2)); ?></td>
        </tr>
    </tfoot>
</table>
<?php else: ?>
<table class="data-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right" style="font-family:monospace;"><?php echo e(number_format($item->quantity_kg, 2)); ?></td>
            <td class="text-right" style="font-family:monospace;">₹<?php echo e(number_format($item->rate_per_kg, 2)); ?></td>
            <td class="text-right" style="font-weight:bold; font-family:monospace; color:#1e40af;">₹<?php echo e(number_format($item->quantity_kg * $item->rate_per_kg, 2)); ?></td>
        </tr>
        ...
        <?php $__currentLoopData = $allPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                <td>
                    ...
                    <div style="font-size:8px; color:#9ca3af;"><?php echo e($payment->date?->format('l')); ?></div>
                </td>
                <td style="color:#4b5563;"><?php echo e($displayDesc); ?></td>
                <td>
                    <?php echo e($payment->payment_mode); ?>

                    <?php if($payment->bank_transfer_type): ?> (<?php echo e($payment->bank_transfer_type); ?>) <?php endif; ?>
                </td>
                ...
                <td class="tr" style="font-weight:bold;">₹<?php echo e(number_format((float)$payment->amount, 2)); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
...
<div class="pay-footer">
    <table>
        <tr>
            ...
            <td class="tr" style="font-weight:bold; font-family:monospace;">₹<?php echo e(number_format((float)($bill->net_amount ?? 0), 2)); ?></td>
        </tr>
        <tr>
            <td style="color:#059669;">Total Paid</td>
            <td class="tr" style="font-weight:bold; font-family:monospace; color:#059669;">₹<?php echo e(number_format($totalPaid ?? 0, 2)); ?></td>
        </tr>
        <tr>
            ...
            <td class="tr" style="font-weight:bold; font-size:12px; font-family:monospace; padding-top:6px; border-top:1px solid #d1d5db; <?php echo e(($remainingDue ?? 0) <= 0 ? 'color:#059669;' : 'color:#dc2626;'); ?>">
